...
import { Send, Loader2, FileText, Download, Sparkles, AlertCircle, Plus, Trash2 } from 'lucide-react';
      ...
      <div className=\"border-b p-3 bg-gray-50\">
        <div className=\"relative\" ref={filesDropdownRef}>
          <button
            ...
            className=\"w-full text-left px-3 py-2 border rounded-lg bg-white hover:bg-gray-50 flex items-center justify-between\"
          >
          ...
          <div className=\"flex flex-col items-center justify-center h-full text-center\">
            ...
            <div className=\"grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl\">
              <button
                ...
                className=\"text-left p-3 border rounded-lg hover:bg-white hover:shadow-sm transition-all\"
              >
